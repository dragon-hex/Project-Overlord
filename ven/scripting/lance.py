"""
NOTE: LANCE will be discontinued in favor of the EIEN/MIRU project.
EIEN/MIRU will be safer and better for a lot of reasons, lance is
too much interpreted, making it slow.
"""
...
if __name__ == '__main__':  
    ...
    print("Lance Project, %s" % VERSION_STR)
    print("Project by Pipes Studios, please check our gitlab!")